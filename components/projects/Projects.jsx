		...
		<section id='projects' className={cl.section}>
			...
			<div className={cl.project_holder}>
				<div className={[cl.imageSide, cl.reverseSideImage].join(' ')}>
					<a href='https://realDaniil.github.io/solid/' target='_blank' className={cl.img_holder}>
				...
				<div className={cl.descriptionSide}>
					...
					<div className={cl.links_holder}>
						<a target='_blank' href="https://github.com/realDaniil/solid">Code <AiFillGithub /></a>
						<a target='_blank' href="https://realDaniil.github.io/solid/">Live Demo <MdOutlineOpenInNew /></a>
					</div>
				</div>
			</div>
			<div className={[cl.project_holder, cl.defaultProject_holder].join(' ')}>
				<div className={cl.descriptionSide}>
					...
					<div className={cl.links_holder}>
						<a target='_blank' href="https://github.com/realDaniil/wallpaper">Code <AiFillGithub /></a>
						<a target='_blank' href="https://realDaniil.github.io/wallpaper/">Live Demo <MdOutlineOpenInNew /></a>
					</div>
				</div>
				<div className={cl.imageSide}>
					<a href='https://realDaniil.github.io/wallpaper/' target='_blank' className={cl.img_holder}>
